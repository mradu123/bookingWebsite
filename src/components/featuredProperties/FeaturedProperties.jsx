  ...
  return (
    <div className="fp">
      <div className="fpItem">
        ...
        <span className="fpCity">Brahmpol Road</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Mementos</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Orchid Hotel</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Novotel Mumbai</span>
        <span className="fpCity">Zuhu Beach</span>
